...
class Game(GameParent):
    def __init__(self, my_subpath=""):
        ...
        self.name = "Legend of Zelda: Dungeons of Infinity"  #to be replaced by a name like "Super Metroid"
        self.console_name = "pc"			#to be replaced by the console name, e.g. "snes"
        self.internal_name = "doi"	#to be replaced by the specific folder name that this app uses, e.g. "metroid3"
